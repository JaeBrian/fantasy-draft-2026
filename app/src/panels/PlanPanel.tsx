...
const PLANS: Record<SlotKey, ReactNode> = {
  ...
  s46: (
    <>
      ...
      <Round rn="Open with the running back"><b>Jonathan Taylor.</b> An earlier study reported that opening a WR was better here; that was an artifact and it is withdrawn. Fixing the position each round forces the draft to take whoever our board lists first at it — and our board has Christian McCaffrey at #6, ahead of Taylor at #9, so the RB-first template drafted McCaffrey about half the time. McCaffrey is worth well over a point a week less than Taylor and is on the board less than half the time, which is the entire reason the RB open looked bad. It was a fact about our board order, not about position.</Round>
      <Round rn="Policies, not templates"><b>Every value-based way of drafting opens Taylor here.</b> Forcing each candidate and playing the season out: Jonathan Taylor <b>105.75</b> (on the board 74% of the time) · James Cook 104.41 (98%) · Christian McCaffrey 104.36 (46%) · Chase Brown 103.25 (100%). The only policy that opens a receiver is the one that reads our board literally, and it finishes well behind. <b className="text-avoid">A round-3 quarterback remains the worst common mistake.</b></Round>
  ...
  s1012: (
    <>
      ...
      <Round rn="Open with a running back"><b>Chase Brown or Derrick Henry.</b> This reversed earlier advice, and it is worth saying why rather than quietly editing it. The case for opening Jefferson rested on a projection the model invented from a curve on his board rank. On Sleeper’s real week-by-week numbers the top four openers here are all running backs: James Cook <b>104.03</b> (on the board just 25% of the time) · <b>Chase Brown 102.85 (100%)</b> · Kenneth Walker III 102.09 (100%) · <b>Derrick Henry 101.81 (100%)</b>.</Round>
      <Round rn="Which one">Cook grades highest but is gone three drafts in four, so plan on Chase Brown or Walker III. Henry is close behind and always there — but he turns 32 this season, and the risk model flags him accordingly: a 44% chance of missing a meaningful stretch against 30% for a back in his prime.</Round>
      <Round rn="Best structure"><b>RB-RB-WR-WR</b> — and RB-first is now unambiguous here: every WR-first line trails it. The five finalists span 1.3.</Round>
      ...
      <Round rn="Sim’s best line">Chase Brown → Walker III → DeVonta Smith → Egbuka → Kraft → Daniels… <span className="text-ink-3">(all numbers on this page now come from Sleeper&apos;s real 2026 projections rather than a curve fitted to our own board order)</span></Round>
    </>
  ),
};
