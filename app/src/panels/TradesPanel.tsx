...
export function TradesPanel(){
 ...
 return <div className="weekly-workspace"><h2>Trade targets</h2><p>Evaluate both teams’ starting lineups, depth, byes and waiver alternatives. Every package is a scenario to review before proposing a trade.</p><WeeklyControls workspace={w} selected={selected} onSelect={setSelected}/>{block&&<section className="weekly-section"><p>{block}</p></section>}{busy&&<p role="status">Evaluating trade packages across future weeks. This may take a minute…</p>}{error&&<p role="alert">{error}</p>}
