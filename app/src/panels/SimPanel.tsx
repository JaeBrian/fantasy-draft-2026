...
export function SimPanel({ noob, initialSeat, onOpenDraft }: { noob: boolean; initialSeat: number; onOpenDraft: (seat: number) => void }) {
  ...
  return (
    <div className="sim-workspace">
      ...
      <p className="study-footnote">Studies model 14 skill rounds and eight starters with flexible TE selection and no early backfield limit. The Draft room applies your current tight-end preference and spreads early RB picks. Projections, injury assumptions and opponent behavior affect the estimates. Scoring-rank percentages describe simulated production, not championship odds.</p>
    </div>
  );
}
