...
Polling matches the real draft room: 2 seconds after each response, including empty drafts and errors. Empty live snapshots clear the board after a Sleeper draft reset.
